...
function createMockBlogService() {
  return {
    ...
    listAll: vi.fn().mockResolvedValue({ items: [], pagination: { page: 1, total: 0, totalPages: 0, hasMore: false, pageSize: 10 } }),
    listPublished: vi.fn().mockResolvedValue({ items: [], pagination: { page: 1, total: 0, totalPages: 0, hasMore: false, pageSize: 10 } }),
